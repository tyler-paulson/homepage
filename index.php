...
$title = 'Tyler Paulson - Web Developer';
$description = 'Specializing in leveraging WordPress, WooCommerce and Vue.js for small businesses and not-for-profits.';
        ...
        <div class="wrap">
            <div class="clients">
                ...
                <ul class="clients_list">
                    ...
                    <li>
                        <div class="clients_list--image">
                            <img alt="Logo" src="/images/br.png" width="97" height="97">
                        </div>
                        <h5>Book Riot</h5>
